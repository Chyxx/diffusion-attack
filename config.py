...
parser.add_argument("--diffusion_path", type=str, default="data/diffusion-ckpt/_7_1562_.pkl")
parser.add_argument("--estimator_path", type=str, default="data/estimator-ckpt/_2_1562_.pkl")
